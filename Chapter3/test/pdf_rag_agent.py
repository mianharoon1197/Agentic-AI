...
# ── Step 2: ChromaDB with built-in embeddings (no API key needed) ─────────────
...
# ChromaDB uses its own local embedding model automatically
